...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'landing.hero.sub': '219 efectos listos para usar —shaders, 3D, scroll, tipografía, partículas, SVG y microinteracciones— con preview en vivo y código copiable. Sin dependencias externas.',
    ...
    'landing.features.3.p': 'Solo se animan las previews visibles (IntersectionObserver). 219 efectos sin fundir el navegador.',
  ...
  en: {
    ...
    'landing.hero.title4': '',
    'landing.hero.sub': '219 ready-to-use effects—shaders, 3D, scroll, typography, particles, SVG, and microinteractions—with live preview and copyable code. Zero external dependencies.',
    ...
    'landing.features.3.p': 'Only visible previews animate (IntersectionObserver). 219 effects without melting the browser.',
  ...
  zh: {
    ...
    'landing.hero.sub': '219 个开箱即用的效果——着色器、3D、滚动、排版、粒子、SVG 和微交互——具有实时预览和可复制的代码。零外部依赖。',
    ...
    'landing.features.3.p': '仅渲染可见的预览（基于 IntersectionObserver）。在不卡顿浏览器的情况下展示 219 个效果。',
